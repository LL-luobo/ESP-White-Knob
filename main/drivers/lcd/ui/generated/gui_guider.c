...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_percent_del = true;
    ui->screen_pow_on_del = true;
    ui->screen_dial_del = true;
    ui->screen_wifi_del = true;
    ui->screen_potatotime_del = true;
    ui->screen_time_2_del = true;
    ui->screen_set_time_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_pow_on(ui);
    lv_scr_load(ui->screen_pow_on);
}
