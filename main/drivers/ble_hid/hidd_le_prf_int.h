...
#define HID_RPT_ID_RADIAL_IN        4    //径向旋钮输入报告ID
#define HID_RPT_ID_VENDOR_OUT       5   // Vendor output report ID
#define HID_RPT_ID_LED_OUT          6  // LED output report ID
#define HID_RPT_ID_FEATURE          0  // Feature report ID
// #define HID_RPT_ID_MEDIA_KEYS_IN    0    //媒质输入报告ID
...
enum {
    ...
    HIDD_LE_IDX_REPORT_RADIAL_IN_CHAR,
    HIDD_LE_IDX_REPORT_RADIAL_IN_VAL,
    HIDD_LE_IDX_REPORT_RADIAL_IN_CCC,
    HIDD_LE_IDX_REPORT_RADIAL_IN_REP_REF,
